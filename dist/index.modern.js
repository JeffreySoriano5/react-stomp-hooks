...
function useSubscription(destinations, onMessage, headers) {
  ...
  }, [].concat(Object.values(_destinations), [onMessage], Object.values(headers)));
}
...
export { StompSessionProvider, useStompClient, useSubscription, withStompClient, withSubscription };
